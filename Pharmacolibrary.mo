package Pharmacolibrary "Modelica library for Pharmacokinetics and Pharmacodynamics (v1.0.0)"
  ...
  package Interfaces
    ...
    connector ConcentrationPortS
      Pharmacolibrary.Types.MassConcentration freeTissueConc "free tissue concentration";
      Pharmacolibrary.Types.MassConcentration freeBloodConc "free blood/plasma concentration";
      flow Pharmacolibrary.Types.MassFlowRate massFlowRate "mass flow rate";
    end ConcentrationPortS;

    model PartialDrugSourceS
      Pharmacolibrary.Interfaces.ConcentrationPortS cport annotation (
        Placement(visible = true, transformation(origin = {0, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      annotation (
        Icon(graphics={  Rectangle(origin = {-18, 6}, lineColor = {114, 159, 207}, lineThickness = 1, extent = {{-12, 54}, {50, -66}}), Line(origin = {0.29, -80}, points = {{0, 20}, {0, -10}}, color = {114, 159, 207}, thickness = 1, arrow = {Arrow.None, Arrow.Half}, arrowSize = 5), Line(origin = {0, 79}, points = {{0, 21}, {0, -99}}, color = {114, 159, 207}, thickness = 2), Line(origin = {-1, 100}, points = {{-29, 0}, {29, 0}}, color = {114, 159, 207}, thickness = 1), Line(origin = {1, -20}, points = {{-31, 0}, {31, 0}}, color = {114, 159, 207}, thickness = 1), Rectangle(origin = {1, -40}, fillColor = {233, 185, 110}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-29, 18}, {29, -18}}), Ellipse(extent = {{-100, 100}, {100, -100}}), Text(origin = {-1, 118}, extent = {{-139, 18}, {139, -18}}, textString = "%name")}, coordinateSystem(initialScale = 0.1)));
  ...
  package Sources
    ...
    model PeriodicDoseS "periodic dose model"
      extends Pharmacolibrary.Interfaces.PartialDrugSource;
      parameter Modelica.Units.SI.Time firstAdminTime(displayUnit="h") = 0 "time of first dose";
      //tStart
      parameter Modelica.Units.SI.Time adminPeriod(displayUnit="h") "time period between doses";
  ...
  package Pharmacokinetic
    ...
    package Systems
      ...
      equation
        ...
        connect(
          testesFlow.port_b, testes.port_b) annotation (
          Line(points = {{6, -124}, {-10, -124}, {-10, -122}}, color = {204, 0, 0}));
        connect(
          testesFlow.port_a, arterial.port_a) annotation (
          Line(points = {{26, -124}, {68, -124}, {68, 22}}, color = {204, 0, 0}));
        connect(
          testes.port_a, venous.port_b) annotation (
          Line(points = {{-30, -122}, {-80, -122}, {-80, -22}, {-50, -22}, {-50, 26}, {-60, 26}}, color = {204, 0, 0}));
        connect(
          restFlow.port_b, rest.port_b) annotation (
          Line(points = {{4, -144}, {-10, -144}}, color = {204, 0, 0}));
        connect(
          restFlow.port_a, arterial.port_a) annotation (
          Line(points = {{24, -144}, {68, -144}, {68, 22}}, color = {204, 0, 0}));
        connect(
          rest.port_a, venous.port_b) annotation (
          Line(points = {{-30, -144}, {-80, -144}, {-80, -22}, {-50, -22}, {-50, 26}, {-60, 26}}, color = {204, 0, 0}));
        connect(
          unidirectionalTransport.cport_a, gut.cport) annotation (
          Line(points = {{50, -40}, {50, -56}, {10, -56}}, color = {114, 159, 207}));
        connect(
          oralDose, lumenCompartment.cport)
          annotation (
          Line(points = {{0, 100}, {50, 100}, {50, 48}}));
        connect(
          unidirectionalTransport.cport_b, lumenCompartment.cport) annotation (
      ...
      extends Pharmacolibrary.Icons.BodyArtieralVenous;
        ...
        Pharmacolibrary.Sources.PeriodicDose oralDose(
          adminDuration(displayUnit="min") = 600,
          adminPeriod=28800,
          doseCount=15,
          firstAdminTime(displayUnit="s") = 60,
          adminMass=0.001) annotation (
          Placement(transformation(origin = {43, 37}, extent = {{-21, -21}, {21, 21}})));
        Sources.PeriodicDose intraVenousDose(
          adminDuration=60,
          adminPeriod=28800,
          doseCount=15,
          firstAdminTime=28800,
          adminMass=0) annotation (
          Placement(transformation(origin = {-75, -73}, extent = {{-21, -21}, {21, 21}})));
        Sources.PeriodicDose arterialDose(
          adminDuration=60,
          adminPeriod=28800,
          doseCount=15,
          firstAdminTime=28800,
        ...
        Sources.PeriodicDose inhalationDose(
          adminDuration=60,
          adminPeriod=28800,
          doseCount=15,
          firstAdminTime=28800,
      ...
      equation
        connect(
          oralDose.cport, wholeBody.oralDose) annotation (
          Line(points={{43,16},{43,12},{-4.8,12}},      color = {114, 159, 207}));
        connect(
          intraVenousDose.cport, wholeBody.venousDose) annotation (
          Line(points = {{-75, -94}, {-38.5, -94}, {-38.5, 2}, {-18, 2}}, color = {114, 159, 207}));
        connect(
          arterialDose.cport, wholeBody.arterialDose) annotation (
          Line(points={{41,-48},{2,-48},{2,2}},        color = {114, 159, 207}));
        connect(
          inhalationDose.cport, wholeBody.inhalationDose) annotation (
          Line(points={{-75,50},{-18,50},{-18,12},{-12.4,12}},        color = {114, 159, 207}));
        connect(
          firstIVDose.cport, wholeBody.venousDose) annotation (
          Line(points = {{-82, -34}, {-38, -34}, {-38, 2}, {-18, 2}}, color = {114, 159, 207}));
        connect(
          firstOralDose.cport, wholeBody.oralDose) annotation (
  ...
  package Examples
    ...
    equation
      ...
      connect(
          fixedFlow.port_b, arteries.port_b) annotation (
        Line(points = {{-20, 0}, {18, 0}, {18, 34}, {14, 34}}, color = {204, 0, 0}));
      connect(
          fixedFlow.port_a, veins.port_a) annotation (
    ...
    equation
      ...
      connect(singleDose.cport, artery.cport) annotation (
        Line(points={{4,56},{4,44}},      color = {114, 159, 207}));
    ...
    equation
      ...
      connect(peripheral.cport_b, clearanceDrivenElimination.cport) annotation (
        Line(points={{-62,39},{-62,32}},      color = {114, 159, 207}));
      annotation (
    ...
    equation
      ...
      connect(intestine_blood.cport_a, blood.cport) annotation (
        Line(points = {{26, 12}, {-6, 12}}, color = {114, 159, 207}));
      connect(
          intestine.cport, intestine_blood.cport_b) annotation (
        Line(points = {{66, 12}, {46, 12}, {46, -8}, {26, -8}}, color = {114, 159, 207}));
      connect(
          drain.cport, blood_elim.cport_a) annotation (
        Line(points = {{-42, -14}, {-42, -8}}, color = {114, 159, 207}));
      annotation (
        experiment(StartTime = 0, StopTime = 864000, Tolerance = 1e-06, Interval = 1728),
        Diagram);
    ...
    model PKWholeBodyModel
      extends Modelica.Icons.Example;
      Pharmacokinetic.Systems.WholeBody wholeBody(ro(displayUnit="kg/m3"))
        annotation (
        Placement(transformation(origin = {-8, -28}, extent = {{-48, -48}, {48, 48}})));
      Sources.PeriodicDose periodicDose(
        firstAdminTime=28800,
        adminPeriod=28800,
        adminMass=0.001,
        doseCount=15,
        adminDuration=60) annotation (
        Placement(transformation(origin = {59, 41}, extent = {{-21, -21}, {21, 21}})));
    equation
      connect(
          periodicDose.cport, wholeBody.oralDose) annotation (
        Line(points={{59,20},{7.36,20}},   color = {114, 159, 207}));
    annotation (
        experiment(StartTime = 0, StopTime = 864000, Tolerance = 1e-06, Interval = 1728));
    end PKWholeBodyModel;
    ...
    model ParacetamolPKWholeBodyModel
      extends Modelica.Icons.Example;
    Pharmacokinetic.Systems.WholeBody wholeBody(ro(displayUnit = "kg/m3"), kTBlu = 0.8, kTBad = 0.2, kTBbo = 0.25, kTBbr = 0.7, kTBhe = 0.9, kTBmu = 0.85, kTBsk = 0.7, kTBgu = 0.9, kTBli = 1.35, kTBsp = 0.9, kTBki = 1.35, kTBte = 0.7, kTBre = 0.8,
        kgit=0.00011111666666667)                                                                                                                                                                                                         annotation (
        Placement(transformation(origin = {-8, -28}, extent = {{-48, -48}, {48, 48}})));
    Sources.PeriodicDose periodicDose(
        firstAdminTime=28800,
        adminPeriod=28800,
        adminMass=0.0015,
        doseCount=7,
        adminDuration(displayUnit="min") = 60)                                                                                             annotation (
        Placement(transformation(origin = {59, 41}, extent = {{-21, -21}, {21, 21}})));
  ...
  extends Modelica.Icons.Package;
    ...
    model ParacetamolComponents
      Pharmacokinetic.Systems.WholeBody wholeBody(
        ro(displayUnit="kg/m3"),
        kTBlu=0.8,
        kTBad=0.2,
        kTBbo=0.25,
        kTBbr=0.7,
        ...
        kTBte=0.7,
        kTBre=0.8,
        kgit=2.776666666666667e-4) annotation (
        Placement(transformation(origin = {-8, -28}, extent = {{-48, -48}, {48, 48}})));
    ...
    package Inhalation
      ...
      equation
        connect(
          solidLumen.cport_a, cport) annotation (
          Line(points = {{78, 3}, {100, 3}, {100, 0}}, color = {114, 159, 207}));
        connect(
          solidLumen.cport_b, dissolution.cport_a) annotation (
          Line(points = {{51, 3}, {51, 0}, {45, 0}, {45, 1}}, color = {114, 159, 207}));
        connect(
          dissolution.cport_b, dissolvedLumen.cport_a) annotation (
          Line(points = {{38, 1}, {38, 5.5}, {30, 5.5}, {30, 8}}, color = {114, 159, 207}));
        connect(
          dissolvedLumen.cport_b, permeability.cport_a) annotation (
          Line(points = {{2, 8}, {-3, 8}, {-3, 0}, {-6, 0}}, color = {114, 159, 207}));
        connect(
          epithelium.cport_a, permeability.cport_b) annotation (
          Line(points = {{-20, 0}, {-14, 0}}, color = {114, 159, 207}));
        connect(
          epithelium.cport_b, permeability1.cport_a) annotation (
          Line(points = {{-48, 0}, {-56, 0}}, color = {114, 159, 207}));
        connect(
          permeability1.cport_b, tissue.cport_a) annotation (
          Line(points = {{-64, 0}, {-70, 0}, {-70, 11}}, color = {114, 159, 207}));
        connect(
          tissue.cport_b, perfusion.cport_a) annotation (
          Line(points = {{-101, 11}, {-101, 23}, {-112, 23}, {-112, 8}}, color = {114, 159, 207}));
        connect(
          perfusion.cport_b, capilary.cport_b) annotation (
          Line(points = {{-120, 8}, {-125, 8}}, color = {114, 159, 207}));
        connect(
          capilary.fport_in1, fport_in1) annotation (
          Line(points = {{-147, -27}, {-147, -96}, {-100, -96}}, color = {204, 0, 0}));
        connect(
          capilary.fport_in, fport_in) annotation (
      ...
      model LungInhalation
        ...
        Pharmacolibrary.Sources.SingleDose singleInhalation(adminMass=1e-4,
            duration(displayUnit="s") = 5) annotation (
          Placement(transformation(origin = {-30, 22}, extent = {{-10, -10}, {10, 10}})));
      equation
        connect(
          singleInhalation.cport, lungLobe.cport) annotation (
          Line(points = {{-30, 12}, {-40, 12}, {-40, -18}}, color = {114, 159, 207}));
        connect(
          singleInhalation.cport, lungLobe2.cport) annotation (
          Line(points = {{-30, 12}, {-18, 12}, {-18, -16}}, color = {114, 159, 207}));
        connect(
          lungLobe3.cport, singleInhalation.cport) annotation (
          Line(points = {{-18, -36}, {-30, -36}, {-30, 12}}, color = {114, 159, 207}));
        connect(
          lungLobe4.cport, singleInhalation.cport) annotation (
          Line(points = {{-18, -56}, {-30, -56}, {-30, 12}}, color = {114, 159, 207}));
        connect(
          lungLobe1.cport, lungLobe.cport) annotation (
      ...
      equation
        ...
        connect(
          mouthThroat.cport, singleInhalation.cport) annotation (
    ...
    package Remdesivir
      ...
      "Simplified model of PK of remdesivir"
        ...
        Pharmacokinetic.NoPerfusedTissueCompartment monophosphate(V=0.001)
          annotation (
          Placement(transformation(origin = {74, -22}, extent = {{-10, -10}, {10, 10}})));
        Pharmacokinetic.NoPerfusedTissueCompartment active_GS443902(V=0.001)
          annotation (
          Placement(transformation(origin = {30, -72}, extent = {{-10, -10}, {10, 10}})));
        Pharmacokinetic.NoPerfusedTissueCompartment nonactive_GS441524(V=0.001)
          annotation (
      ...
      equation
        ...
        connect(
          monophosphate.cport, hydrolaze.cport_a) annotation (
          Line(points = {{74, -12}, {54, -12}, {54, -2}}, color = {114, 159, 207}));
        connect(
          nucleotidase.cport_b, monophosphate.cport) annotation (
          Line(points = {{16, -24}, {54, -24}, {54, -12}, {74, -12}}, color = {114, 159, 207}));
        connect(
          ph1.cport_b, hydrolaze.cport_a) annotation (
          Line(points = {{56, -38}, {54, -38}, {54, -2}}, color = {114, 159, 207}));
        connect(
          ph1.cport_a, active_GS443902.cport) annotation (
          Line(points = {{56, -58}, {30, -58}, {30, -62}}, color = {114, 159, 207}));
        connect(
          active_GS443902.cport, A_RDV_elim.cport) annotation (
          Line(points = {{30, -62}, {-56, -62}}, color = {114, 159, 207}));
        connect(
          nucleotidase.cport_a, nonactive_GS441524.cport) annotation (
          Line(points = {{-4, -24}, {-30, -24}, {-30, -22}}, color = {114, 159, 207}));
        connect(
          nonactive_GS441524.cport, nonA_RDV_elim.cport) annotation (
    ...
    "Simplified model of PK of remdesivir"
      Sources.PeriodicDose periodicDose(firstAdminTime = 86400, adminPeriod = 86400, adminMass = 1e-4, doseCount = 10, adminDuration = 3600) annotation (
        Placement(transformation(origin = {-78, 80}, extent = {{-10, -10}, {10, 10}})));
        Sources.SingleDose firstDose(
          adminTime=3600,
          adminMass=2e-4,
          duration=3600) annotation (
          Placement(transformation(origin = {-32, 80}, extent = {{-10, -10}, {10, 10}})));
        Pharmacolibrary.Pharmacokinetic.TissueCompartment lungs(V=0.271, kTB=1)
          annotation (
          Placement(transformation(origin = {-28, 52}, extent = {{-10, -10}, {10, 10}})));
        Pharmacolibrary.Pharmacokinetic.SystemicCompartment arteries(V=0.001)
          annotation (
          Placement(transformation(origin = {10, 52}, extent = {{-10, -10}, {10, 10}})));
        Pharmacolibrary.Pharmacokinetic.SystemicCompartment veins(V=0.003)
          annotation (
          Placement(transformation(origin = {-60, 52}, extent = {{-10, -10}, {10, 10}})));
        Pharmacolibrary.Pharmacokinetic.FixedFlow fixedFlow(Q=
              8.333333333333332e-5) annotation (
          Placement(transformation(origin = {-24, 26}, extent = {{-10, -10}, {10, 10}})));
        Pharmacolibrary.Pharmacokinetic.FlowGround fground annotation (
          Placement(transformation(origin = {-60, 36}, extent = {{-10, -10}, {10, 10}})));
        Pharmacokinetic.PeripheralTissueCompartment non_active_GS704277(
          CL=5.555555555555555e-5,
          V=0.005,
          cBSwitch=false) annotation (
          Placement(transformation(origin = {55, 53}, extent = {{-15, -15}, {15, 15}})));
        Pharmacolibrary.Pharmacokinetic.ClearanceDrivenElimination RDV_elim(CL=
              5.555555555555555e-6) annotation (
          Placement(transformation(origin = {-88, 12}, extent = {{-10, -10}, {10, 10}})));
        Pharmacokinetic.ClearanceDrivenElimination nonA_RDV_elim(CL=
              7.666666666666666e-6) annotation (
    ...
    equation
        ...
        connect(RDV_elim.cport, veins.cport) annotation (
          Line(points = {{-88, 22}, {-88, 62}, {-60, 62}}, color = {114, 159, 207}));
        connect(
          nonA_RDV_elim.cport, non_active_GS704277.cport_b) annotation (
          Line(points={{56,22},{56,30},{56,39.5},{55,39.5}},
                                              color = {114, 159, 207}));
        annotation (
        experiment(StartTime = 0, StopTime = 864000, Tolerance = 1e-09, Interval = 17.28),
        Diagram,
          Documentation(info=
                "<html><head></head><body>Remdesivir (RDV) GS-5734 is antiviral to treat COVID-19, it is a prodrug of an adenosine analogue.&nbsp;<div><br></div><div>As Remdesivir bioavailability is almost 0 it is not fit for oral administration, thus intravenous administration is recommended first dose 200mg and other 4 - 10 doses per 100 mg every 24 h with intravenous application typically 30-60 minutes.&nbsp;</div><div><br></div><div>RDV is taken by target cell and metabolized in multiple steps (utilizing enzymes hydrolaze, phosphataze) to form active form GS-443902. It is also metabolised (nucleotidase) to nonactive form GS-441524.&nbsp;</div><div>Critical is concentration of active form in target cells.</div><div><br></div><div>RDV, active and non_active have different clearance rate elimination by kidneys/liver.</div><div><br></div><div><br></div><div><div>References:</div></div><div>[1] Li, R., Liclican, A., Xu, Y., Pitts, J., Niu, C., Zhang, J., Kim, C., Zhao, X., Soohoo, D., Babusis, D., Yue, Q., Ma, B., Murray, B. P., Subramanian, R., Xie, X., Zou, J., Bilello, J. P., Li, L., Schultz, B. E., … Feng, J. Y. (2021). Key metabolic enzymes involved in Remdesivir activation in human lung cells. <i>Antimicrobial Agents and Chemotherapy</i>, <i>65</i>(9). https://doi.org/10.1128/AAC.00602-21</div><div><br></div><div>[2] Humeniuk, R., Mathias, A., Cao, H., Osinusi, A., Shen, G., Chng, E., Ling, J., Vu, A., &amp; German, P. (2020). Safety, Tolerability, and Pharmacokinetics of Remdesivir, An Antiviral for Treatment of COVID-19, in Healthy Subjects. <i>Clinical and Translational Science</i>, <i>13</i>(5), 896–906. https://doi.org/10.1111/cts.12840</div><div><br></div><div><br></div></body></html>",
              revisions=
                "<html><head></head><body>2025 Tomas Kulhanek, Ph.D., VITO NV<div><br></div></body></html>"));
    ...
    package Architecture
      ...
      model Absorption
        Pharmacolibrary.Interfaces.ConcentrationPortS oralDose annotation (
          Placement(transformation(origin = {0, 100}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {32, 100}, extent = {{-10, -10}, {10, 10}})));
      ...
      equation
        connect(
          absorption.pharmaBus, distribution.pharmaBus) annotation (
          Line(points = {{7, 26}, {8, 26}, {8, -12}, {-16, -12}}, color = {255, 204, 51}, thickness = 0.5));
        connect(
          absorption.pharmaBus, metabolism.pharmaBus) annotation (
          Line(points = {{7, 26}, {8, 26}, {8, -8}, {36, -8}}, color = {255, 204, 51}, thickness = 0.5));
        connect(
          elimination.pharmaBus, absorption.pharmaBus) annotation (
    ...
    package SingleCompartment
      ...
      */
      ...
      model PBPKModel
        ...
        Elimination elimination(Cl=Cl*1e-3/3600) annotation (
          Placement(transformation(origin = {-3, -57}, extent = {{-29, -29}, {29, 29}})));
        Metabolism metabolism annotation (
          Placement(transformation(origin = {51, -13}, extent = {{-27, -27}, {27, 27}})));
        Pharmacolibrary.Sources.PeriodicDoseS periodicDose(
          adminDuration(displayUnit="s") = adminDuration,
          adminMass=adminMassMg*1e-6,
          adminPeriod=28800,
          doseCount=7,
          firstAdminTime(displayUnit="s") = 60) annotation (
          ...
          parameter Real Vd = VdPerKg * 1e-3 * weight "Volume of distribution (m3)" annotation(Dialog(group = "Raw parameters (computed from above)"));
          parameter Real Cmin = 0.004 "minimal therapeutic range" annotation(Dialog(group = "Raw parameters (computed from above)"));
          parameter Real Cmax = 0.008 "minimal therapeutic range" annotation(Dialog(group = "Raw parameters (computed from above)"));
      equation
        connect(
          absorption.pharmaBus, elimination.pharmaBus) annotation (
          Line(points={{-3,26},{-3,-28.58}},   color = {255, 204, 51}, thickness = 0.5));
        connect(
          distribution.pharmaBus, absorption.pharmaBus) annotation (
          Line(points={{-34.64,-12.64},{-3,-12.64},{-3,26}},
                                                           color = {255, 204, 51}, thickness = 0.5));
        connect(
          metabolism.pharmaBus, absorption.pharmaBus) annotation (
          Line(points={{38.04,-13},{-3,-13},{-3,26}},     color = {255, 204, 51}, thickness = 0.5));
        connect(
          periodicDose.cport, absorption.oralDose) annotation (
          Line(points={{59,70},{28,70},{28,92},{7.56,92}},       color = {114, 159, 207}));
      annotation (
          Icon(graphics={  Bitmap(origin = {-58, -2}, extent = {{-98, -98}, {98, 98}}, imageSource = ""), Bitmap(origin = {13, 69}, extent = {{-27, -29}, {27, 29}}, imageSource = ""), Text(origin = {131, -31}, extent = {{-149, 69}, {149, -69}},
           horizontalAlignment=TextAlignment.Left,
                textColor={0,0,0},
                textString="Weight = %weight
Absorption (bioavailability)
F = %F
Distribution (volume of d.)
Vd = %VdPerKg [L/kg]
Elimination (clearance)
Cl = %Cl [L/h]"),                                     Text(origin = {7, 120}, extent = {{-147, 20}, {147, -20}}, textString = "%name"), Text(origin = {187, 83}, extent = {{-145, 19}, {145, -19}},
                   horizontalAlignment=TextAlignment.Left,
                textString="duration: %adminDuration
mass: %adminMassMg",
                textColor={0,0,0})},                           coordinateSystem(extent = {{-160, 140}, {280, -100}})));
      end PBPKModel;

      model ParacetamolPK
        PBPKModel acetaminophen(
          VdPerKg=0.9,
          F=0.8,
          Cl=20,
          adminDuration=1200,
          adminMassMg=1000,
          weight=75) annotation (
          Placement(transformation(origin = {-40, 35.4545}, extent = {{-56, -30.5455}, {56, 30.5455}})));
      equation

      annotation (
          Icon, experiment(StopTime=864000, __Dymola_Algorithm="Dassl"));
      end ParacetamolPK;

      model GentamicinePK
        PBPKModel gentamicine(
          VdPerKg=0.9,
          F=0.03,
          Cl=5) annotation (
          Placement(transformation(origin = {-40, 36}, extent = {{-48, -48}, {48, 48}})));
        PBPKModel gentamicineIV(
          periodicDose(
            adminDuration(displayUnit="min") = 30*60,
            adminMass=0.001,
            adminPeriod=28800,
            doseCount=1,
            firstAdminTime(displayUnit="s") = 60),
...
<pre style=\"margin-top: 0px; margin-bottom: 0px;\"><br><pre style=\"margin-top: 0px; margin-bottom: 0px;\"><!--EndFragment--></pre><!--EndFragment--></pre></body></html>"));
      ...
      model TheopyllinePK
        PBPKModel theopyilline(
          VdPerKg=0.9,
          F=0.9,
          Cl=0.4,
          adminDuration=12*60*60) annotation (
      ...
      model LithiumPK
        PBPKModel lithiumCarbonate(
          VdPerKg=3,
          F=0.95,
          Cl=9.4,
          adminDuration=43200,
          adminMassMg=1500,
          periodicDose(adminPeriod=86400, doseCount=14))
          annotation (Placement(transformation(extent={{-92,4},{36,74}})));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
              coordinateSystem(preserveAspectRatio=false)));
      end LithiumPK;

      model RemdesivirPK
        PBPKModel remdesivir(
          VdPerKg=3.6,
          F=1,
          Cl=187,
          adminMassMg=1000,
          periodicDose(adminPeriod=86400, doseCount=7))
          annotation (Placement(transformation(extent={{-82,0},{24,58}})));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
              coordinateSystem(preserveAspectRatio=false)));
      end RemdesivirPK;
