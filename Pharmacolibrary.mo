  ...
  package Interfaces
    ...
    connector FlowPort_a
      ...
      annotation(
        ...
        Icon(coordinateSystem(initialScale = 0.1), graphics = {Polygon(lineColor = {204, 0, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, lineThickness = 2, points = {{-80, 0}, {0, 80}, {80, 0}, {0, -80}, {-80, 0}})}),
    ...
    partial model PartialTwoPort
      Pharmacolibrary.Interfaces.FlowPort_a port_a annotation(
        Placement(transformation(origin = {-94, 0}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-100, 0}, extent = {{-28, -28}, {28, 28}})));
      Pharmacolibrary.Interfaces.FlowPort_b port_b annotation(
        Placement(transformation(origin = {96, 0}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {100, 0}, extent = {{-28, -28}, {28, 28}})));
    end PartialTwoPort;

    partial model PartialOnePort
      Pharmacolibrary.Interfaces.FlowPort_a port_a annotation(
        Placement(transformation(origin = {-94, 0}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-100, 2}, extent = {{-26, -26}, {26, 26}})));
    end PartialOnePort;
    ...
    connector BloodTissueConcentrationPort_b
      extends Pharmacolibrary.Interfaces.BloodTissueConcentrationPort;
      annotation(
        defaultComponentName = "cport_b",
        ...
        Diagram(coordinateSystem(initialScale = 0.1)));
    end BloodTissueConcentrationPort_b;
    ...
    partial model PartialTwoCPort
      ...
      ConcentrationPort_b cport_b annotation(
        Placement(transformation(extent = {{-10, -98}, {10, -78}}), iconTransformation(origin = {0, 76}, extent = {{-20, -196}, {20, -156}})));
    end PartialTwoCPort;
...
//if cBSwitch then cport.freeBloodConc else cport.freeTissueConc;
  ...
  package Icons
    ...
    equation
      ...
      annotation(
        Icon(graphics = {Rectangle(origin = {0, -47}, fillColor = {247, 199, 199}, fillPattern = FillPattern.Solid, extent = {{-96, 41}, {96, -41}}), Rectangle(origin = {0, 28}, fillColor = {185, 218, 234}, fillPattern = FillPattern.Solid, extent = {{-96, 24}, {96, -24}}), Rectangle(origin = {0, -1}, lineColor = {46, 194, 126}, fillColor = {51, 209, 122}, fillPattern = FillPattern.Solid, lineThickness = 2, extent = {{-96, 5}, {96, -5}}), Line(origin = {37.5, -1}, points = {{0, -16}, {0, 16}}, color = {246, 97, 81}, thickness = 1, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 4), Line(origin = {-27.5555, -6.33333}, points = {{0, 16}, {0, -16}}, color = {153, 193, 241}, thickness = 1, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 4), Text(origin = {1, 32}, extent = {{-133, 18}, {133, -18}}, textString = "%name"), Text(origin = {8, -61}, extent = {{-132, 19}, {132, -19}}, textString = "V=%V"), Text(origin = {9, -34}, extent = {{-131, 18}, {131, -18}}, textString = "kTB=%kTB")}));
    ...
    equation
      ...
      annotation(
        Icon(graphics = {Rectangle(origin = {0, -41}, fillColor = {247, 199, 199}, fillPattern = FillPattern.Solid, extent = {{-96, 41}, {96, -41}}), Text(origin = {-1, 30}, extent = {{-133, 18}, {133, -18}}, textString = "%name"), Text(origin = {-4, -39}, extent = {{-130, 19}, {130, -19}}, textString = "V=%V")}));
    end BloodPlasma;
    ...
    equation
      ...
      annotation(
        Icon(graphics = {Rectangle(origin = {0, -16}, fillColor = {185, 218, 234}, fillPattern = FillPattern.Solid, extent = {{-96, 66}, {96, -66}}), Rectangle(origin = {0, -86}, lineColor = {46, 194, 126}, fillColor = {51, 209, 122}, fillPattern = FillPattern.Solid, lineThickness = 2, extent = {{-80, 4}, {80, -4}}), Line(origin = {-64.3336, -81.574}, points = {{0, 16}, {0, -16}}, color = {153, 193, 241}, thickness = 1, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 4), Text(origin = {-1, 24}, extent = {{-133, 18}, {133, -18}}, textString = "%name"), Text(origin = {0, -67}, extent = {{-132, 19}, {132, -19}}, textString = "V=%V"), Text(origin = {3, -34}, extent = {{-131, 18}, {131, -18}}, textString = "kTB=%kTB")}));
    end Tissue;
    ...
    package Systems
      ...
      model WholeBody
        ...
        parameter Real kTBre = 0.8 "rest of body tissue to blood concentration ratio" annotation(
          Dialog(group = "Concentration Ratios"));
        parameter Pharmacolibrary.Types.TimeAging kgit = 2.776666666666667e-4 "transfer coeficient from GIT" annotation(
          Dialog(group = "Other"));
...
//  port_a.p = 1;
    ...
    model ConcBoundary
      ...
      Interfaces.ConcentrationPort_a cport annotation(
        Placement(transformation(origin = {0, 60}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {0, 100}, extent = {{-20, -20}, {20, 20}})));
    equation
      cport.conc = freeTissueConc;
//cport.freeBloodConc = freeBloodConc;
    ...
    model SignalConcBoundary
      ...
      Interfaces.ConcentrationPort_a cport annotation(
        Placement(transformation(origin = {0, 60}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {0, 60}, extent = {{-10, -10}, {10, 10}})));
    equation
...
//cport.freeBloodConc = cBlood*mgl2kgm3;
    ...
    equation
      cport_a.massFlowRate = cA*CLa - cB*CLb;
      annotation(
  ...
  <h1>SystemicCompartment</h1><div>Systemic compartment is same as TissueCompartment, but the kTB is always 1, so that the concentration in tissue is not considered and is always same as blood/plasma concentration.</div></body></html>"));
    ...
    model PeripheralTissueCompartment "compartment including calculation of diffusion transport"
      ...
      Pharmacolibrary.Interfaces.ConcentrationPort_b cport_b annotation(
        Placement(transformation(origin = {0, -90}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {0, -100}, extent = {{-20, -20}, {20, 20}})));
  ...
  package Models
    ...
    package Inhalation
      ...
      model RespiratoryCompartment
        ...
        Interfaces.FlowPort_a flowOut annotation(
      ...
      model SolidLumen
        Pharmacolibrary.Interfaces.ConcentrationPortA cport_a annotation(
          Placement(transformation(origin = {100, 2}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {40, 0}, extent = {{-10, -10}, {10, 10}})));
        Pharmacolibrary.Interfaces.ConcentrationPortB cport_b annotation(
      ...
      model Dissolution
        ...
        Interfaces.ConcentrationPortB cport_b annotation(
      ...
      model Capilary
        ...
        Interfaces.ConcentrationPortA cport_b annotation(
...
// Total concentration is the sum of all individual dose contributions
      ...
      model ComponentRemdesivirPK "Simplified model of PK of remdesivir"
        Sources.PeriodicDose periodicDose(firstAdminTime = 86400, adminPeriod = 86400, adminMass = 1e-4, doseCount = 10, adminDuration = 3600) annotation(
          Placement(transformation(origin = {-78, 80}, extent = {{-10, -10}, {10, 10}})));
        Sources.SingleDose firstDose(adminTime = 3600, adminMass = 2e-4, duration = 3600) annotation(
          Placement(transformation(origin = {-32, 80}, extent = {{-10, -10}, {10, 10}})));
...
// Plasma concentration calculation
    ...
    package SingleCompartment
      ...
      model PBPKModel
        ...
        Pharmacolibrary.Sources.PeriodicDoseS periodicDose(adminDuration(displayUnit = "s") = adminDuration, adminMass = adminMassMg*1e-6, adminPeriod = adminPeriod, doseCount = 7, firstAdminTime(displayUnit = "s") = 60) annotation(
          Placement(transformation(origin = {73, 81}, extent = {{-11, -11}, {11, 11}})));
        ...
        parameter Real Vd = VdPerKg*1e-3*weight "Volume of distribution (m3)" annotation(
          Dialog(group = "Raw parameters (computed from above)"));
        parameter Real Cmin = 0.004 "minimal therapeutic range" annotation(
          Dialog(group = "Raw parameters (computed from above)"));
        parameter Real Cmax = 0.008 "minimal therapeutic range" annotation(
          Dialog(group = "Raw parameters (computed from above)"));
      equation
        ...
        connect(distribution.pharmaBus, absorption.pharmaBus) annotation(
          Line(points = {{-34.64, -12.64}, {-3, -12.64}, {-3, 26}}, color = {255, 204, 51}, thickness = 0.5));
  ...
  mass: %adminMassMg", textColor = {0, 0, 0})}, coordinateSystem(extent = {{-160, 140}, {280, -100}})));
      ...
      model GentamicinePK
        ...
        PBPKModel gentamicineIV(periodicDose(adminDuration(displayUnit = "min") = 30*60, adminMass = 0.001, adminPeriod = 28800, doseCount = 1, firstAdminTime(displayUnit = "s") = 60), VdPerKg = 0.9, Cl = 5, F = 1) annotation(
...
// Compute concentrations (assuming known volumes)
    ...
    package Processes
      ...
      model Absorption
        Interfaces.ConcentrationPortB c_outport annotation(
          Placement(transformation(origin = {0, -98}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {0, -98}, extent = {{-10, -10}, {10, 10}})));
      equation

        annotation(
          Icon(graphics = {Bitmap(extent = {{-98, -98}, {98, 98}}, imageSource = ""), Line(origin = {86.52, -0.98}, points = {{-68, 0}, {8, 0}}, color = {237, 51, 59}, thickness = 4), Line(origin = {21.7814, 86.88}, points = {{8, 7}, {8, -7}, {-12, -7}, {-12, -55}}, color = {255, 163, 72}, thickness = 4, smooth = Smooth.Bezier), Line(origin = {-31.926, 85.1147}, points = {{-11, 9}, {-11, -1}, {33, 1}}, color = {153, 193, 241}, thickness = 4, smooth = Smooth.Bezier), Line(origin = {-34.4539, 24.2169}, points = {{-50, 0}, {8, 0}}, color = {53, 132, 228}, thickness = 4), Text(origin = {-1, -111}, extent = {{-125, 13}, {125, -13}}, textString = "%name"), Line(origin = {-17.9591, -56.7109}, points = {{-50, 0}, {8, 0}}, color = {53, 132, 228}, thickness = 4), Line(origin = {63.5046, 39.3292}, points = {{-36, 0}, {28, 0}}, color = {237, 51, 59}, thickness = 4), Text(origin = {74, 84}, extent = {{-30, 8}, {30, -8}}, textString = "oral"), Text(origin = {-72, 80}, extent = {{-30, 8}, {30, -8}}, textString = "inhalation")}));
      end Absorption;
