...
model SingleDoseIVAmiodarone
  ...
  Pharmacokinetic.TissueCompartment tissue(V = 90*70*0.001, kTB = 1) annotation(
  ...
  Pharmacokinetic.SystemicCompartment veins(V = 0.004) annotation(
  ...
  Sources.SingleDose singleDose(adminMass = 4e-4, duration = 1800, adminTime = 7200) annotation(
  ...
  Pharmacokinetic.ClearanceDrivenElimination kidneyElim(CL = 1e-6*70/60) annotation(
