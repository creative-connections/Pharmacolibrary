...
model AcetaminophenEquations
  Pharmacolibrary.Types.MassConcentration C(displayUnit = "mg/l") "concentration";
  Real H "heaviside step function";
  Real effectiveDose "dose that is effectively absorbed";
  Real eliminationRate "rate the drug is cleared from";
  Real ammountDrug "ammount of the drug administered";
  Real halfLife "half life of the drug";
