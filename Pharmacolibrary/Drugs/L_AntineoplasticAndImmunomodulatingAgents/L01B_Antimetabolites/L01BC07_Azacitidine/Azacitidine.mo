...
model Azacitidine
  extends Pharmacolibrary.Drugs.ATC.L.L01BC07
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Azacitidine</td></tr><tr><td>ATC code:</td><td>L01BC07</td></tr><td>route:</td><td>intravenous</td></tr>
