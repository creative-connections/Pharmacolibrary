...
model Gefitinib
  extends Pharmacolibrary.Drugs.ATC.L.L01EB01
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Gefitinib</td></tr><tr><td>ATC code:</td><td>L01EB01</td></tr><td>route:</td><td>oral</td></tr>
