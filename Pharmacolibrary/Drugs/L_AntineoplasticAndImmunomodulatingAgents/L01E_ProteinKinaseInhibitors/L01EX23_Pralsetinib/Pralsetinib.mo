...
info       = "<html><body><table><tr><td>Drug:</td><td>L01EX23</td></tr><td>route:</td><td>oral</td></tr><tr><td>n-compartments</td><td>2</td></tr></table><p>Pralsetinib is an orally administered, selective RET receptor tyrosine kinase inhibitor used for the treatment of RET fusion-positive non-small cell lung cancer (NSCLC) and RET-mutant or RET fusion-positive thyroid cancers. It is approved by the FDA and EMA for these indications.</p><h4>Pharmacokinetics</h4><p>Pharmacokinetic parameters reported for adult patients with advanced solid tumors, based on population PK analysis.</p><h4>References</h4><ol></ol></body></html>",
