...
model Belimumab
  extends Pharmacolibrary.Drugs.ATC.L.L04AG04
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Belimumab</td></tr><tr><td>ATC code:</td><td>L04AG04</td></tr><td>route:</td><td>intravenous</td></tr>
