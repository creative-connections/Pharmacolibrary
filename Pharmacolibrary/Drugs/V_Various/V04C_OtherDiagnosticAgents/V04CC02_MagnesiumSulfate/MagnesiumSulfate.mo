within Pharmacolibrary.Drugs.V_Various.V04C_OtherDiagnosticAgents.V04CC02_MagnesiumSulfate;

model MagnesiumSulfate
  extends Pharmacolibrary.Drugs.ATC.V.V04CC02
