...
model Acetylcysteine
  extends Pharmacolibrary.Drugs.ATC.V.V03AB23
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Acetylcysteine</td></tr><tr><td>ATC code:</td><td>V03AB23</td></tr><td>route:</td><td>intravenous</td></tr>
