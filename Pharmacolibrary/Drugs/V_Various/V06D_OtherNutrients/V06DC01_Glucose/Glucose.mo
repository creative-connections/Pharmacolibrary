within Pharmacolibrary.Drugs.V_Various.V06D_OtherNutrients.V06DC01_Glucose;

model Glucose
  extends Pharmacolibrary.Drugs.ATC.V.V06DC01
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Glucose</td></tr><tr><td>ATC code:</td><td>V06DC01</td></tr><td>route:</td><td>intravenous</td></tr>
