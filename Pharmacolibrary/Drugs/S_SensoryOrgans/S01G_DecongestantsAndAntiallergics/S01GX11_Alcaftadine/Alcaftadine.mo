...
model Alcaftadine
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Alcaftadine</td></tr><tr><td>ATC code:</td><td>S01GX11</td></tr><td>route:</td><td>ophthalmic</td></tr>
    <tr><td>compartments:</td><td>1</td></tr>
    <tr><td>dosage:</td><td>0.25</td><td>mg</td></tr>
    <tr><td>volume of distribution:</td><td>1</td><td>L</td></tr>
    <tr><td>clearance:</td><td>0</td><td></td></tr>
    <tr><td colspan='3'>other parameters in model implementation</td></tr>
    </table><p>Alcaftadine is an H1 histamine receptor antagonist used as a topical ophthalmic solution for the prevention of itching associated with allergic conjunctivitis. It is currently approved and marketed for this use.</p><h4>Pharmacokinetics</h4><p>Estimated pharmacokinetic parameters for topical ocular administration in adults. No human systemic pharmacokinetic studies published; data primarily from product labeling and pharmacology reviews.</p><h4>References</h4><ol></ol></body></html>",
