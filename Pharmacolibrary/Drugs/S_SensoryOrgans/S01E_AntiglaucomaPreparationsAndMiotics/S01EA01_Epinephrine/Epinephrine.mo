...
model Epinephrine
  extends Pharmacolibrary.Drugs.ATC.S.S01EA01
  ...
  /*
    ...
    Ctox_trough    = 0.01,            
    Vdp             = 0.0027,
    k12             = 9.444444444444446e-05,
    k21             = 9.444444444444446e-05
      
  */
  ;

  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Epinephrine</td></tr><tr><td>ATC code:</td><td>S01EA01</td></tr><td>route:</td><td>intravenous</td></tr>
