...
model Cocaine
  extends Pharmacolibrary.Drugs.ATC.S.S01HA01
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Cocaine</td></tr><tr><td>ATC code:</td><td>S01HA01</td></tr><td>route:</td><td>intravenous</td></tr>
