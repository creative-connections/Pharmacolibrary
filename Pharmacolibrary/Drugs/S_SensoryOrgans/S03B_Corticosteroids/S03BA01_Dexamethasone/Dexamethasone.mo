...
model Dexamethasone
  extends Pharmacolibrary.Drugs.ATC.S.S03BA01
  ...
  /*
    ...
    Ctox_trough    = 0.01,            
    Vdp             = 0.00064,
    k12             = 1.438888888888889e-06,
    k21             = 1.438888888888889e-06
      
  */
  ;

  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Dexamethasone</td></tr><tr><td>ATC code:</td><td>S03BA01</td></tr><td>route:</td><td>intravenous</td></tr>
