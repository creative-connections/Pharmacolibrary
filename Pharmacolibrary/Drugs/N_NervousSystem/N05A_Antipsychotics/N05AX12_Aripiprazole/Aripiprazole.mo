within Pharmacolibrary.Drugs.N_NervousSystem.N05A_Antipsychotics.N05AX12_Aripiprazole;

model Aripiprazole
  extends Pharmacolibrary.Drugs.ATC.N.N05AX12
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Aripiprazole</td></tr><tr><td>ATC code:</td><td>N05AX12</td></tr><td>route:</td><td>oral</td></tr>
