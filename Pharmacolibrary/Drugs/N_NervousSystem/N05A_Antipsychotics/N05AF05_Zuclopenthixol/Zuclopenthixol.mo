within Pharmacolibrary.Drugs.N_NervousSystem.N05A_Antipsychotics.N05AF05_Zuclopenthixol;

model Zuclopenthixol
  extends Pharmacolibrary.Drugs.ATC.N.N05AF05
