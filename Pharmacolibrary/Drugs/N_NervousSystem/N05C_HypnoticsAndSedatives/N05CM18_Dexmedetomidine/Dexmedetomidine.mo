within Pharmacolibrary.Drugs.N_NervousSystem.N05C_HypnoticsAndSedatives.N05CM18_Dexmedetomidine;

model Dexmedetomidine
  extends Pharmacolibrary.Drugs.ATC.N.N05CM18
