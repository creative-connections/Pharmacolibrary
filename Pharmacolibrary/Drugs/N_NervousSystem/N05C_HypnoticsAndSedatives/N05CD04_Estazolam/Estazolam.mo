...
info       = "<html><body><table><tr><td>name:</td><td>Estazolam</td></tr><tr><td>ATC code:</td><td>N05CD04</td></tr><td>route:</td><td>oral</td></tr><tr><td>n-compartments</td><td>1</td></tr></table><p>Estazolam is a triazolobenzodiazepine derivative with anxiolytic, hypnotic, and sedative properties, mainly used in the short-term management of insomnia. It functions as a central nervous system depressant by enhancing the effect of the neurotransmitter GABA at the GABAA receptor. Estazolam is approved and used medicinally in several countries but its use has declined in favor of other hypnotics in some regions due to side effects and risk of dependence.</p><h4>Pharmacokinetics</h4><p>Single-dose pharmacokinetic data from healthy adult volunteers after oral administration.</p><h4>References</h4><ol></ol></body></html>",
