...
model Bupivacaine
  extends Pharmacolibrary.Drugs.ATC.N.N01BB01
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Bupivacaine</td></tr><tr><td>ATC code:</td><td>N01BB01</td></tr><td>route:</td><td>intravenous</td></tr>
