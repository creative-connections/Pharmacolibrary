...
model Propofol
  extends Pharmacolibrary.Drugs.ATC.N.N01AX10
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Propofol</td></tr><tr><td>ATC code:</td><td>N01AX10</td></tr><td>route:</td><td>intravenous</td></tr>
