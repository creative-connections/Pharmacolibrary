within Pharmacolibrary.Drugs.N_NervousSystem.N01A_AnestheticsGeneral.N01AH01_Fentanyl;

model Fentanyl
  extends Pharmacolibrary.Drugs.ATC.N.N01AH01
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Fentanyl</td></tr><tr><td>ATC code:</td><td>N01AH01</td></tr><td>route:</td><td>intravenous</td></tr>
