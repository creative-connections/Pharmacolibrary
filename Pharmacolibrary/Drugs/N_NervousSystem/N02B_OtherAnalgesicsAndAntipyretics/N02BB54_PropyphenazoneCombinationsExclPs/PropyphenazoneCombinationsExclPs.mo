within Pharmacolibrary.Drugs.N_NervousSystem.N02B_OtherAnalgesicsAndAntipyretics.N02BB54_PropyphenazoneCombinationsExclPs;

model PropyphenazoneCombinationsExclPs
...
end PropyphenazoneCombinationsExclPs;
