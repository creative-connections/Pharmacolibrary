within Pharmacolibrary.Drugs.N_NervousSystem.N02B_OtherAnalgesicsAndAntipyretics.N02BB74_PropyphenazoneCombinationsWithPs;

model PropyphenazoneCombinationsWithPs
...
end PropyphenazoneCombinationsWithPs;
