within Pharmacolibrary.Drugs.N_NervousSystem.N02B_OtherAnalgesicsAndAntipyretics.N02BE51_ParacetamolCombinationsExclPsych;

model ParacetamolCombinationsExclPsych
...
end ParacetamolCombinationsExclPsych;
