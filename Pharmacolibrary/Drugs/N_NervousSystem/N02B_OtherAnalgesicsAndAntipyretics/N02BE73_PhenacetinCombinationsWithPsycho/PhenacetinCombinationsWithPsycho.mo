within Pharmacolibrary.Drugs.N_NervousSystem.N02B_OtherAnalgesicsAndAntipyretics.N02BE73_PhenacetinCombinationsWithPsycho;

model PhenacetinCombinationsWithPsycho
...
end PhenacetinCombinationsWithPsycho;
