within Pharmacolibrary.Drugs.N_NervousSystem.N02B_OtherAnalgesicsAndAntipyretics.N02BE74_BucetinCombinationsWithPsycholep;

model BucetinCombinationsWithPsycholep
...
end BucetinCombinationsWithPsycholep;
