within Pharmacolibrary.Drugs.N_NervousSystem.N02B_OtherAnalgesicsAndAntipyretics.N02BE53_PhenacetinCombinationsExclPsycho;

model PhenacetinCombinationsExclPsycho
...
end PhenacetinCombinationsExclPsycho;
