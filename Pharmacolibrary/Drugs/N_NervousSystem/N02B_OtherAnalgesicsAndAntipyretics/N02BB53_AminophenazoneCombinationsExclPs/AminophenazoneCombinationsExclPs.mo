within Pharmacolibrary.Drugs.N_NervousSystem.N02B_OtherAnalgesicsAndAntipyretics.N02BB53_AminophenazoneCombinationsExclPs;

model AminophenazoneCombinationsExclPs
...
end AminophenazoneCombinationsExclPs;
