within Pharmacolibrary.Drugs.N_NervousSystem.N02C_AntimigrainePreparations.N02CA52_ErgotamineCombinationsExclPsycho;

model ErgotamineCombinationsExclPsycho
...
end ErgotamineCombinationsExclPsycho;
