...
model Caffeine
  extends Pharmacolibrary.Drugs.ATC.N.N06BC01(Vd = 0.035, adminMass = 9.5e-5);
  ...
  /*
      ...
      */
  annotation(
    Documentation(info = "<html><body><table><tr><td>name:</td><td>Caffeine</td></tr><tr><td>ATC code:</td><td>N06BC01</td></tr><td>route:</td><td>oral</td></tr>
