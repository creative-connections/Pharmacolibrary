...
info       = "<html><body><table><tr><td>Drug:</td><td>N06BX01</td></tr><td>route:</td><td>oral</td></tr><tr><td>n-compartments</td><td>1</td></tr></table><p>Meclofenoxate (also known as centrophenoxine) is a cholinergic nootropic drug formerly used to treat symptoms of senile dementia and Alzheimer's disease. It is thought to enhance cholinergic function and improve memory, though it is not currently approved for medical use in most countries.</p><h4>Pharmacokinetics</h4><p>No quality-controlled human pharmacokinetic (PK) data for meclofenoxate could be identified in primary literature. The following PK parameters are estimated from indirect or secondary sources.</p><h4>References</h4><ol></ol></body></html>",
