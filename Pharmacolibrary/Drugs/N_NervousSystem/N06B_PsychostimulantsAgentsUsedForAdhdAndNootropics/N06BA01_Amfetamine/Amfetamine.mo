...
model Amfetamine
  extends Pharmacolibrary.Drugs.ATC.N.N06BA01
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Amfetamine</td></tr><tr><td>ATC code:</td><td>N06BA01</td></tr><td>route:</td><td>oral</td></tr>
