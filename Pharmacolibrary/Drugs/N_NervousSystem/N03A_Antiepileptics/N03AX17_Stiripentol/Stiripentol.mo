within Pharmacolibrary.Drugs.N_NervousSystem.N03A_Antiepileptics.N03AX17_Stiripentol;

model Stiripentol
  extends Pharmacolibrary.Drugs.ATC.N.N03AX17
