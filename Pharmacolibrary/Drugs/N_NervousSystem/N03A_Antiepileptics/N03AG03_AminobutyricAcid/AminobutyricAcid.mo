within Pharmacolibrary.Drugs.N_NervousSystem.N03A_Antiepileptics.N03AG03_AminobutyricAcid;

model AminobutyricAcid
  extends Pharmacolibrary.Drugs.ATC.N.N03AG03
