...
model Tiagabine
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Tiagabine</td></tr><tr><td>ATC code:</td><td>N03AG06</td></tr><td>route:</td><td>oral</td></tr>
