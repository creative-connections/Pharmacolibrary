within Pharmacolibrary.Drugs.N_NervousSystem.N02A_Opioids.N02AJ09_CodeineAndOtherNonOpioid;

model CodeineAndOtherNonOpioid
  extends Pharmacolibrary.Drugs.ATC.N.N02AJ09
