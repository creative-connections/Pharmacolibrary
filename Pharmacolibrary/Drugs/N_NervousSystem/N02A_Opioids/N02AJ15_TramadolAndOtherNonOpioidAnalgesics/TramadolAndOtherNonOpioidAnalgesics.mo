within Pharmacolibrary.Drugs.N_NervousSystem.N02A_Opioids.N02AJ15_TramadolAndOtherNonOpioidAnalgesics;

model TramadolAndOtherNonOpioidAnalgesics
...
end TramadolAndOtherNonOpioidAnalgesics;
