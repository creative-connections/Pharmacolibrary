...
model Esketamine
  ...
  /*
    ...
    Ctox_trough    = 0.01,            
    Vdp             = 1.87,
    k12             = 4.722222222222223e-05,
    k21             = 4.722222222222223e-05
      
  */
  ;

  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Esketamine</td></tr><tr><td>ATC code:</td><td>N06AX27</td></tr><td>route:</td><td>intranasal</td></tr>
    <tr><td>compartments:</td><td>2</td></tr>
    <tr><td>dosage:</td><td>56</td><td>mg</td></tr>
    <tr><td>volume of distribution:</td><td>709</td><td>L</td></tr>
    <tr><td>clearance:</td><td>89.2</td><td>L/h</td></tr>
