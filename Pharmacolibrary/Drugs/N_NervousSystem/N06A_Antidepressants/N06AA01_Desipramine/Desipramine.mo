within Pharmacolibrary.Drugs.N_NervousSystem.N06A_Antidepressants.N06AA01_Desipramine;

model Desipramine
  extends Pharmacolibrary.Drugs.ATC.N.N06AA01
