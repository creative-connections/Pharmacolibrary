...
model Isocarboxazid
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Isocarboxazid</td></tr><tr><td>ATC code:</td><td>N06AF01</td></tr><td>route:</td><td>oral</td></tr>
    <tr><td>compartments:</td><td>1</td></tr>
    <tr><td>dosage:</td><td>10</td><td>mg</td></tr>
    <tr><td>volume of distribution:</td><td>1.2</td><td>L</td></tr>
    <tr><td>clearance:</td><td>25</td><td>L/h</td></tr>
    <tr><td colspan='3'>other parameters in model implementation</td></tr>
    </table><p>Isocarboxazid is a non-selective, irreversible monoamine oxidase inhibitor (MAOI) formerly used as an antidepressant for the treatment of major depressive disorder. Due to safety concerns, especially dietary restrictions and risk of hypertensive crisis, its clinical use has been largely discontinued in many countries.</p><h4>Pharmacokinetics</h4><p>No specific published human pharmacokinetic parameter studies were identified for isocarboxazid; estimates are provided based on general MAOI and pharmacokinetic principles, assuming healthy adult oral administration.</p><h4>References</h4><ol></ol></body></html>",
