...
model Prednisolone
  extends Pharmacolibrary.Drugs.ATC.D.D07XA02
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Prednisolone</td></tr><tr><td>ATC code:</td><td>D07XA02</td></tr><td>route:</td><td>oral</td></tr>
