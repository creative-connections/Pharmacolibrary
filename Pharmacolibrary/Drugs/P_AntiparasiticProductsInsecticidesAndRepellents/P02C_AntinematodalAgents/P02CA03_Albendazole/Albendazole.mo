...
model Albendazole
  extends Pharmacolibrary.Drugs.ATC.P.P02CA03
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Albendazole</td></tr><tr><td>ATC code:</td><td>P02CA03</td></tr><td>route:</td><td>oral</td></tr>
