...
model ClofenotaneCombinations
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>ClofenotaneCombinations</td></tr><tr><td>ATC code:</td><td>P03AB51</td></tr><td>route:</td><td>oral</td></tr>
