...
model Apomorphine
  extends Pharmacolibrary.Drugs.ATC.G.G04BE07
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Apomorphine</td></tr><tr><td>ATC code:</td><td>G04BE07</td></tr><td>route:</td><td>subcutaneous</td></tr>
