within Pharmacolibrary.Drugs.M_MusculoSkeletalSystem.M03B_MuscleRelaxantsCentrallyActingAgents.M03BB52_ChlormezanoneCombinationsExclPsy;

model ChlormezanoneCombinationsExclPsy
...
end ChlormezanoneCombinationsExclPsy;
