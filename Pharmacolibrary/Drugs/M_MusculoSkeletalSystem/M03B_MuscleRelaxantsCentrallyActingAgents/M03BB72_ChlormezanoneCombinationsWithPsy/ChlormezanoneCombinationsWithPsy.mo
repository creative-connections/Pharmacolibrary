within Pharmacolibrary.Drugs.M_MusculoSkeletalSystem.M03B_MuscleRelaxantsCentrallyActingAgents.M03BB72_ChlormezanoneCombinationsWithPsy;

model ChlormezanoneCombinationsWithPsy
...
end ChlormezanoneCombinationsWithPsy;
