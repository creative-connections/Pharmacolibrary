within Pharmacolibrary.Drugs.M_MusculoSkeletalSystem.M09A_OtherDrugsForDisordersOfTheMusculoSkeletalSystem.M09AX15_DelandistrogeneMoxeparvo;

model DelandistrogeneMoxeparvo
