...
model Flurbiprofen
  extends Pharmacolibrary.Drugs.ATC.M.M02AA19
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Flurbiprofen</td></tr><tr><td>ATC code:</td><td>M02AA19</td></tr><td>route:</td><td>oral</td></tr>
