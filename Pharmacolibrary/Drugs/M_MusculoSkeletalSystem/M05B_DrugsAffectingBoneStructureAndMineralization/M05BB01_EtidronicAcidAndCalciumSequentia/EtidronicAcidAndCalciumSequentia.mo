within Pharmacolibrary.Drugs.M_MusculoSkeletalSystem.M05B_DrugsAffectingBoneStructureAndMineralization.M05BB01_EtidronicAcidAndCalciumSequentia;

model EtidronicAcidAndCalciumSequentia
...
end EtidronicAcidAndCalciumSequentia;
