within Pharmacolibrary.Drugs.M_MusculoSkeletalSystem.M05B_DrugsAffectingBoneStructureAndMineralization.M05BX53_StrontiumRanelateAndColecalcifer;

model StrontiumRanelateAndColecalcifer
...
end StrontiumRanelateAndColecalcifer;
