...
model Allopurinol
  extends Pharmacolibrary.Drugs.ATC.M.M04AA01(Cl = 2.7777777777777775e-6, Vd = 0.112);
  ...
  /*
      ...
      */
  annotation(
    Documentation(info = "<html><body><table><tr><td>name:</td><td>Allopurinol</td></tr><tr><td>ATC code:</td><td>M04AA01</td></tr><td>route:</td><td>oral</td></tr>
