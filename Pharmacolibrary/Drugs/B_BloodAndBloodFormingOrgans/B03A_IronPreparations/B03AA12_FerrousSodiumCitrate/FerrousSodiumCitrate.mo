...
info       = "<html><body><table><tr><td>Drug:</td><td>B03AA12</td></tr><td>route:</td><td>oral</td></tr><tr><td>n-compartments</td><td>1</td></tr></table><p>Ferrous sodium citrate is an iron supplement used to treat or prevent iron deficiency anemia. It is a water-soluble salt of iron that is sometimes used in oral formulations. Its use is mostly limited to dietary supplements and is not widely approved as a prescription drug in most countries.</p><h4>Pharmacokinetics</h4><p>Estimated pharmacokinetic parameters for healthy adults, as specific data is not reported in literature sources.</p><h4>References</h4><ol></ol></body></html>",
