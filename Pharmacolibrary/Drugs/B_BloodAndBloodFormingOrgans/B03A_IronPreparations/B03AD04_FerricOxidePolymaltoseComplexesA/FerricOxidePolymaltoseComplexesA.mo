within Pharmacolibrary.Drugs.B_BloodAndBloodFormingOrgans.B03A_IronPreparations.B03AD04_FerricOxidePolymaltoseComplexesA;

model FerricOxidePolymaltoseComplexesA
...
end FerricOxidePolymaltoseComplexesA;
