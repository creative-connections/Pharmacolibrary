...
model Ticagrelor
  extends Pharmacolibrary.Drugs.ATC.B.B01AC24
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Ticagrelor</td></tr><tr><td>ATC code:</td><td>B01AC24</td></tr><td>route:</td><td>oral</td></tr>
