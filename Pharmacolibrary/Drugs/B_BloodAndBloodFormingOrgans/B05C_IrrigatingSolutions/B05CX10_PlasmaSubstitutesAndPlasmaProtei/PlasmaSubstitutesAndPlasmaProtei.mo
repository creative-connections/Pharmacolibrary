within Pharmacolibrary.Drugs.B_BloodAndBloodFormingOrgans.B05C_IrrigatingSolutions.B05CX10_PlasmaSubstitutesAndPlasmaProtei;

model PlasmaSubstitutesAndPlasmaProtei
...
end PlasmaSubstitutesAndPlasmaProtei;
