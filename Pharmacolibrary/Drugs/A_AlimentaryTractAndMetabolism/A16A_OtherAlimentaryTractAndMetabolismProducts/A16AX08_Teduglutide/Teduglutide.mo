...
model Teduglutide
  extends Pharmacolibrary.Drugs.ATC.A.A16AX08
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Teduglutide</td></tr><tr><td>ATC code:</td><td>A16AX08</td></tr><td>route:</td><td>subcutaneous</td></tr>
