...
info       = "<html><body><table><tr><td>Drug:</td><td>A16AB06</td></tr><td>route:</td><td>oral</td></tr><tr><td>n-compartments</td><td>1</td></tr></table><p>Sacrosidase is an orally administered enzyme replacement therapy derived from Saccharomyces cerevisiae, used for the treatment of congenital sucrase-isomaltase deficiency (CSID), a rare inherited metabolic disorder. It is approved for clinical use in patients with CSID to facilitate the hydrolysis of dietary sucrose.</p><h4>Pharmacokinetics</h4><p>There are no published pharmacokinetic studies reporting classical PK parameters for sacrosidase, as it is an enzyme replacement therapy that acts locally in the intestinal lumen and is minimally absorbed systemically. The following values are estimated or not applicable.</p><h4>References</h4><ol></ol></body></html>",
