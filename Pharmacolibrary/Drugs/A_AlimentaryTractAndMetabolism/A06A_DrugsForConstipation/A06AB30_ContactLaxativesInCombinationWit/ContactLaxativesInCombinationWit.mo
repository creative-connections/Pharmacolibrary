within Pharmacolibrary.Drugs.A_AlimentaryTractAndMetabolism.A06A_DrugsForConstipation.A06AB30_ContactLaxativesInCombinationWit;

model ContactLaxativesInCombinationWit
...
end ContactLaxativesInCombinationWit;
