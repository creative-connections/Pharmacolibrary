...
info       = "<html><body><table><tr><td>Drug:</td><td>A06AD01</td></tr><td>route:</td><td>oral</td></tr><tr><td>n-compartments</td><td>1</td></tr></table><p>Magnesium carbonate is an inorganic salt used as a magnesium supplement. It is commonly employed as an antacid to relieve symptoms of indigestion and heartburn and to correct magnesium deficiency. Magnesium carbonate is still available and used for such purposes today. It is classified under ATC code A06AD01 in the laxatives category, specifically as a saline laxative.</p><h4>Pharmacokinetics</h4><p>Pharmacokinetic parameters in healthy adults, orally administered. No specific clinical pharmacokinetic studies for magnesium carbonate identified; parameters estimated based on general pharmacokinetics of orally administered inorganic magnesium salts.</p><h4>References</h4><ol></ol></body></html>",
