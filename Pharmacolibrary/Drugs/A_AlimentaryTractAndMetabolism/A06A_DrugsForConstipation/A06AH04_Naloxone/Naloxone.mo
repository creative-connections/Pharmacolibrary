...
model Naloxone
  extends Pharmacolibrary.Drugs.ATC.A.A06AH04
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Naloxone</td></tr><tr><td>ATC code:</td><td>A06AH04</td></tr><td>route:</td><td>intravenous</td></tr>
