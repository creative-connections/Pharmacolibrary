...
model Fenpiprane
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Fenpiprane</td></tr><tr><td>ATC code:</td><td>A03AX01</td></tr><td>route:</td><td>oral</td></tr>
    <tr><td>compartments:</td><td>1</td></tr>
    <tr><td>dosage:</td><td>50</td><td>mg</td></tr>
    <tr><td>volume of distribution:</td><td>150</td><td>L</td></tr>
    <tr><td>clearance:</td><td>15</td><td>L/h</td></tr>
    <tr><td colspan='3'>other parameters in model implementation</td></tr>
    </table><p>Fenpiprane is an antimuscarinic agent formerly used as an antispasmodic for the treatment of functional gastrointestinal disorders such as irritable bowel syndrome. It is not approved or widely used today in clinical practice.</p><h4>Pharmacokinetics</h4><p>No published pharmacokinetic studies reporting quantitative PK parameters for fenpiprane in humans were found. The following values are theoretical estimates based on typical values for orally administered antispasmodic compounds in adults.</p><h4>References</h4><ol></ol></body></html>",
