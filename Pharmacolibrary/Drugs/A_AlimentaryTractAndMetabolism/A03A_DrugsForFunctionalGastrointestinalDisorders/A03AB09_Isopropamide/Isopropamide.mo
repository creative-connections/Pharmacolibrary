...
info       = "<html><body><table><tr><td>Drug:</td><td>A03AB09</td></tr><td>route:</td><td>oral</td></tr><tr><td>n-compartments</td><td>1</td></tr></table><p>Isopropamide is a synthetic anticholinergic agent that was historically used to treat peptic ulcers and other gastrointestinal disorders including irritable bowel syndrome and gastric hyperacidity. It acts by inhibiting muscarinic acetylcholine receptors, resulting in decreased gastric and intestinal motility and secretion. Isopropamide is not commonly used in current clinical practice due to the availability of newer and safer agents.</p><h4>Pharmacokinetics</h4><p>No pharmacokinetic models or human PK studies with reported compartmental model parameters were identified from published literature sources. Values below are estimated based on class-related antimuscarinic/anticholinergic GI drugs and typical values for oral antimuscarinics in adults.</p><h4>References</h4><ol></ol></body></html>",
