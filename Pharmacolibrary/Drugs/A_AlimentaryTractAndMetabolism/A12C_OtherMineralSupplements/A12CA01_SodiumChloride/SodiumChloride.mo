...
model SodiumChloride
  extends Pharmacolibrary.Drugs.ATC.A.A12CA01
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>SodiumChloride</td></tr><tr><td>ATC code:</td><td>A12CA01</td></tr><td>route:</td><td>intravenous</td></tr>
