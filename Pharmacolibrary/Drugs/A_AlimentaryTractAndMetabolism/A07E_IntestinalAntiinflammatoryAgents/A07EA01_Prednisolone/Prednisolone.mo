...
model Prednisolone
  extends Pharmacolibrary.Drugs.ATC.A.A07EA01
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Prednisolone</td></tr><tr><td>ATC code:</td><td>A07EA01</td></tr><td>route:</td><td>oral</td></tr>
