...
model Betamethasone
  extends Pharmacolibrary.Drugs.ATC.A.A07EA04
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Betamethasone</td></tr><tr><td>ATC code:</td><td>A07EA04</td></tr><td>route:</td><td>oral</td></tr>
