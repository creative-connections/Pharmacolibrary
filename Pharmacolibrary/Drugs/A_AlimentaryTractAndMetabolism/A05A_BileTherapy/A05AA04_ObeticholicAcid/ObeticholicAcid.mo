...
info       = "<html><body><table><tr><td>Drug:</td><td>A05AA04</td></tr><td>route:</td><td>oral</td></tr><tr><td>n-compartments</td><td>2</td></tr></table><p>Obeticholic acid is a semi-synthetic bile acid analog that acts as a potent agonist of the farnesoid X receptor (FXR). It is used for the treatment of primary biliary cholangitis (PBC) in adults, particularly in those who show inadequate response to or are intolerant of ursodeoxycholic acid. It is an FDA-approved drug.</p><h4>Pharmacokinetics</h4><p>Pharmacokinetic parameters were reported in healthy adult volunteers, both male and female, after single and repeated oral administration.</p><h4>References</h4><ol></ol></body></html>",
