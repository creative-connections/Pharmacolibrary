within Pharmacolibrary.Drugs.A_AlimentaryTractAndMetabolism.A02A_Antacids.A02AF02_OrdinarySaltCombinationsAndAntif;

model OrdinarySaltCombinationsAndAntif
...
end OrdinarySaltCombinationsAndAntif;
