...
model Prednisolone_1
  extends Pharmacolibrary.Drugs.ATC.A.A01AC04_1
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Prednisolone_1</td></tr><tr><td>ATC code:</td><td>A01AC04_1</td></tr><td>route:</td><td>intravenous</td></tr>
