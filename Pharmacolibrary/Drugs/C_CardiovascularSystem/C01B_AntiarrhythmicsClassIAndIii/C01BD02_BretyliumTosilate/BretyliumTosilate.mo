...
info       = "<html><body><table><tr><td>name:</td><td>BretyliumTosilate</td></tr><tr><td>ATC code:</td><td>C01BD02</td></tr><td>route:</td><td>intravenous</td></tr><tr><td>n-compartments</td><td>2</td></tr></table><p>Bretylium tosilate is a quaternary ammonium antiarrhythmic agent that was historically used for the treatment of life-threatening ventricular arrhythmias, such as ventricular fibrillation and ventricular tachycardia, particularly in emergency settings. It acts by inhibiting norepinephrine release from sympathetic nerve terminals, thus possessing both antiadrenergic and direct cardiac effects. Its clinical use has become rare due to the availability of more effective and safer antiarrhythmic drugs, and it is no longer commonly approved or marketed in many countries.</p><h4>Pharmacokinetics</h4><p>Pharmacokinetic parameters derived from healthy adult volunteers after intravenous administration.</p><h4>References</h4><ol></ol></body></html>",
