...
model Clofenamide
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Clofenamide</td></tr><tr><td>ATC code:</td><td>C03BA07</td></tr><td>route:</td><td>oral</td></tr>
    <tr><td>compartments:</td><td>1</td></tr>
    <tr><td>dosage:</td><td>100</td><td>mg</td></tr>
    <tr><td>volume of distribution:</td><td>30</td><td>L</td></tr>
    <tr><td>clearance:</td><td>50</td><td>mL/min</td></tr>
    <tr><td colspan='3'>other parameters in model implementation</td></tr>
    </table><p>Clofenamide is a diuretic drug from the sulfonamide family, historically used for the management of hypertension and edema associated with heart failure or renal disorders. It is not widely used today and is not approved or available in many countries due to the presence of safer and more effective alternatives.</p><h4>Pharmacokinetics</h4><p>No published pharmacokinetic models or human PK parameter data for clofenamide were identified in the literature or indexed pharmacokinetic databases as of 2024.</p><h4>References</h4><ol></ol></body></html>",
