within Pharmacolibrary.Drugs.C_CardiovascularSystem.C05A_AgentsForTreatmentOfHemorrhoidsAndAnalFissuresFo.C05AA05_Betamethasone;

model Betamethasone
  extends Pharmacolibrary.Drugs.ATC.C.C05AA05
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Betamethasone</td></tr><tr><td>ATC code:</td><td>C05AA05</td></tr><td>route:</td><td>oral</td></tr>
