...
info       = "<html><body><table><tr><td>Drug:</td><td>C02DG01</td></tr><td>route:</td><td>oral</td></tr><tr><td>n-compartments</td><td>1</td></tr></table><p>Pinacidil is a vasodilator drug acting as an ATP-sensitive potassium channel opener. It was primarily developed for the management of hypertension but is now largely obsolete and not in widespread clinical use. Pinacidil causes relaxation of vascular smooth muscle, leading to decreased blood pressure.</p><h4>Pharmacokinetics</h4><p>No published clinical pharmacokinetic data found for pinacidil in humans. Parameters are estimated based on its chemical class, typical drug characteristics, and secondary references.</p><h4>References</h4><ol></ol></body></html>",
