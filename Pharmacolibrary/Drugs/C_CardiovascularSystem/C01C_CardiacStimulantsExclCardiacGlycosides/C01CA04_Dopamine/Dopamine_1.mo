...
model Dopamine_1
  extends Pharmacolibrary.Drugs.ATC.C.C01CA04_1
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Dopamine_1</td></tr><tr><td>ATC code:</td><td>C01CA04_1</td></tr><td>route:</td><td>intravenous</td></tr>
