within Pharmacolibrary.Drugs.C_CardiovascularSystem.C07D_BetaBlockingAgentsThiazidesAndOtherDiuretics.C07DA06_TimololThiazidesAndOther;

model TimololThiazidesAndOther
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>TimololThiazidesAndOtherDiuretics</td></tr><tr><td>ATC code:</td><td>C07DA06</td></tr><td>route:</td><td>oral</td></tr>
