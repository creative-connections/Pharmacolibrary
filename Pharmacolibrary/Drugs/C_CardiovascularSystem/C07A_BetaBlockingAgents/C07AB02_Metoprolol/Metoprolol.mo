...
annotation (Documentation(
    info = "<html><head></head><body><table><tbody><tr><td>name:</td><td>Metoprolol</td></tr><tr><td>ATC code:</td><td>C07AB02</td></tr><tr><td>route:</td><td>oral</td></tr>
