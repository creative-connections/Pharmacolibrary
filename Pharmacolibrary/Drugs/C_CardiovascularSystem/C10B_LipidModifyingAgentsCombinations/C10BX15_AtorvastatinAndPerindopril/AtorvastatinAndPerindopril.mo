...
info       = "<html><body><table><tr><td>Drug:</td><td>C10BX15</td></tr><td>route:</td><td>oral</td></tr><tr><td>n-compartments</td><td>2</td></tr></table><p>The fixed combination of atorvastatin (a statin that inhibits HMG-CoA reductase, lowering cholesterol) and perindopril (an angiotensin-converting enzyme inhibitor used to treat hypertension and heart failure). This combination is approved for use in adults to reduce cardiovascular risk in patients with hypertension or dyslipidemia.</p><h4>Pharmacokinetics</h4><p>No published population pharmacokinetic studies for the fixed combination of atorvastatin and perindopril (ATC code C10BX15) in adults, healthy volunteers, or special patient groups. The following parameters are estimated based on the most common reported values for oral administration of atorvastatin and perindopril individually in healthy adults.</p><h4>References</h4><ol></ol></body></html>",
