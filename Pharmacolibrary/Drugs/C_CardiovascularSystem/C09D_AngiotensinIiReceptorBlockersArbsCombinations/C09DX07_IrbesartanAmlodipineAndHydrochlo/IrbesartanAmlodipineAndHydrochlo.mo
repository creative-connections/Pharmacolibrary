within Pharmacolibrary.Drugs.C_CardiovascularSystem.C09D_AngiotensinIiReceptorBlockersArbsCombinations.C09DX07_IrbesartanAmlodipineAndHydrochlo;

model IrbesartanAmlodipineAndHydrochlo
...
end IrbesartanAmlodipineAndHydrochlo;
