within Pharmacolibrary.Drugs.C_CardiovascularSystem.C03E_DiureticsAndPotassiumSparingAgentsInCombination.C03EA12_MetolazoneAndPotassiumSparingAge;

model MetolazoneAndPotassiumSparingAge
...
end MetolazoneAndPotassiumSparingAge;
