within Pharmacolibrary.Drugs.H_SystemicHormonalPreparationsExclSexHormonesAndInsulins.H01C_HypothalamicHormones.H01CC54_RelugolixEstradiolAndNorethister;

model RelugolixEstradiolAndNorethister
...
end RelugolixEstradiolAndNorethister;
