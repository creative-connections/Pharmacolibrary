within Pharmacolibrary.Drugs.J_AntiinfectivesForSystemicUse.J07A_BacterialVaccines.J07AH02_OtherMeningococcalMonovalentPuri;

model OtherMeningococcalMonovalentPuri
...
end OtherMeningococcalMonovalentPuri;
