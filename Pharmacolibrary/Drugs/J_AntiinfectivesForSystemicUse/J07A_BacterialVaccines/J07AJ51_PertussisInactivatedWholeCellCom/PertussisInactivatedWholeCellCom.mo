within Pharmacolibrary.Drugs.J_AntiinfectivesForSystemicUse.J07A_BacterialVaccines.J07AJ51_PertussisInactivatedWholeCellCom;

model PertussisInactivatedWholeCellCom
...
end PertussisInactivatedWholeCellCom;
