within Pharmacolibrary.Drugs.J_AntiinfectivesForSystemicUse.J07B_ViralVaccines.J07BX05_RespiratorySyncytialViru;

model RespiratorySyncytialViru
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>RespiratorySyncytialVirusVaccines</td></tr><tr><td>ATC code:</td><td>J07BX05</td></tr><td>route:</td><td>intramuscular</td></tr>
