within Pharmacolibrary.Drugs.J_AntiinfectivesForSystemicUse.J07B_ViralVaccines.J07BD51_MeaslesCombinationsWithMumpsLive;

model MeaslesCombinationsWithMumpsLive
...
end MeaslesCombinationsWithMumpsLive;
