...
model Tosufloxacin
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Tosufloxacin</td></tr><tr><td>ATC code:</td><td>J01MA22</td></tr><td>route:</td><td>oral</td></tr>
