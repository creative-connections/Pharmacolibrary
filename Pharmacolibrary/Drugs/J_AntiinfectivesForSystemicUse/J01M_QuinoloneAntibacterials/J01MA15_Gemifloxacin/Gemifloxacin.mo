...
model Gemifloxacin
  extends Pharmacolibrary.Drugs.ATC.J.J01MA15
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Gemifloxacin</td></tr><tr><td>ATC code:</td><td>J01MA15</td></tr><td>route:</td><td>oral</td></tr>
