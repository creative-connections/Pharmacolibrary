...
model Mecillinam
  extends Pharmacolibrary.Drugs.ATC.J.J01CA11
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Mecillinam</td></tr><tr><td>ATC code:</td><td>J01CA11</td></tr><td>route:</td><td>oral</td></tr>
