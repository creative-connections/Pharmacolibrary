within Pharmacolibrary.Drugs.J_AntiinfectivesForSystemicUse.J01C_BetaLactamAntibacterialsPenicillins.J01CE10_BenzathinePhenoxymethylpenicilli;

model BenzathinePhenoxymethylpenicilli
...
end BenzathinePhenoxymethylpenicilli;
