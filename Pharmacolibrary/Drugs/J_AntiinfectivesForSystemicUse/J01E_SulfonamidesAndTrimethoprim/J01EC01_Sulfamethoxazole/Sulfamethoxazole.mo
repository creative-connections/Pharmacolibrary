...
model Sulfamethoxazole
  extends Pharmacolibrary.Drugs.ATC.J.J01EC01
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Sulfamethoxazole</td></tr><tr><td>ATC code:</td><td>J01EC01</td></tr><td>route:</td><td>oral</td></tr>
