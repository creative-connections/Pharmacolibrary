...
model Rifapentine
  extends Pharmacolibrary.Drugs.ATC.J.J04AB05
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Rifapentine</td></tr><tr><td>ATC code:</td><td>J04AB05</td></tr><td>route:</td><td>oral</td></tr>
