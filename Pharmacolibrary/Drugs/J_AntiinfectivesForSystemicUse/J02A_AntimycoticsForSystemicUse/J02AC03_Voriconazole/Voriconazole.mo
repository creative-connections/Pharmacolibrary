...
model Voriconazole
  extends Pharmacolibrary.Drugs.ATC.J.J02AC03
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Voriconazole</td></tr><tr><td>ATC code:</td><td>J02AC03</td></tr><td>route:</td><td>oral</td></tr>
