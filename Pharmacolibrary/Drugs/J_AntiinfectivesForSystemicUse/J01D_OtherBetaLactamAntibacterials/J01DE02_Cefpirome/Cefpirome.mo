...
model Cefpirome
  extends Pharmacolibrary.Drugs.ATC.J.J01DE02
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Cefpirome</td></tr><tr><td>ATC code:</td><td>J01DE02</td></tr><td>route:</td><td>intravenous</td></tr>
