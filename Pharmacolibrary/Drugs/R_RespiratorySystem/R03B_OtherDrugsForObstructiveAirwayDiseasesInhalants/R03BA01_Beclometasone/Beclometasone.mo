...
model Beclometasone
  extends Pharmacolibrary.Drugs.ATC.R.R03BA01
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Beclometasone</td></tr><tr><td>ATC code:</td><td>R03BA01</td></tr><td>route:</td><td>inhalation</td></tr>
