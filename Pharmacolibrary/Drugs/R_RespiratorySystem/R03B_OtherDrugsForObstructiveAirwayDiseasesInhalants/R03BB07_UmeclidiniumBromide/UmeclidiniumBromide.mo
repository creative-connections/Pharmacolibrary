...
model UmeclidiniumBromide
  extends Pharmacolibrary.Drugs.ATC.R.R03BB07
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>UmeclidiniumBromide</td></tr><tr><td>ATC code:</td><td>R03BB07</td></tr><td>route:</td><td>inhalation</td></tr>
