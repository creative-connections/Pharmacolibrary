within Pharmacolibrary.Drugs.R_RespiratorySystem.R03D_OtherSystemicDrugsForObstructiveAirwayDiseases.R03DB02_CholineTheophyllinateAndAdrenerg;

model CholineTheophyllinateAndAdrenerg
...
end CholineTheophyllinateAndAdrenerg;
