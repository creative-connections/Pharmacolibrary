...
model Theophylline_1
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Theophylline_1</td></tr><tr><td>ATC code:</td><td>R03DA04_1</td></tr><td>route:</td><td>intravenous</td></tr>
