within Pharmacolibrary.Drugs.R_RespiratorySystem.R07A_OtherRespiratorySystemProducts.R07AX32_IvacaftorTezacaftorAndElexacafto;

model IvacaftorTezacaftorAndElexacafto
...
end IvacaftorTezacaftorAndElexacafto;
