within Pharmacolibrary.Drugs.R_RespiratorySystem.R01A_DecongestantsAndOtherNasalPreparationsForTopical.R01AB01_Phenylephrine;

model Phenylephrine
  extends Pharmacolibrary.Drugs.ATC.R.R01AB01
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Phenylephrine</td></tr><tr><td>ATC code:</td><td>R01AB01</td></tr><td>route:</td><td>oral</td></tr>
