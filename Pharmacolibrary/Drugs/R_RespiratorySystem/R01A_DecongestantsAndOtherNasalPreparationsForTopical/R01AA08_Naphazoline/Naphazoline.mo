...
model Naphazoline
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Naphazoline</td></tr><tr><td>ATC code:</td><td>R01AA08</td></tr><td>route:</td><td>nasal</td></tr>
