...
model Phenylephrine
  extends Pharmacolibrary.Drugs.ATC.R.R01AA04
  ...
  */
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Phenylephrine</td></tr><tr><td>ATC code:</td><td>R01AA04</td></tr><td>route:</td><td>oral</td></tr>
