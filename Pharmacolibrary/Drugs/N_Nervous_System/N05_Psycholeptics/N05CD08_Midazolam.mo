within Pharmacolibrary.Drugs.N_Nervous_System.N05_Psycholeptics;

model N05CD08_Midazolam
  extends Pharmacolibrary.Pharmacokinetic.Models.PK_2C(Cl = 3.3333333333333333e-6, F = 1, k12 = 3.3333333333333333e-6, k21 = 1.6666666666666667e-6, adminDuration = 60, adminMass = 9.6e-6, adminCount = 1, Vd = 0.03, Vdp = 0.03, Cmin = 6e-5);
equation
