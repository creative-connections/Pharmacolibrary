...
model P02CA03_1
  ...
  annotation(Documentation(
    info ="<html><body><p>Albendazole is an anthelmintic drug used to treat a broad range of parasitic worm infestations, including neurocysticercosis, hydatid disease, giardiasis, and soil-transmitted helminthiases. It disrupts the microtubule formation in parasites, leading to their immobilization and death. Albendazole is widely approved and used globally for these indications.</p><h4>Pharmacokinetics</h4><p>Pharmacokinetic parameters reported in healthy adult volunteers after a single 400 mg oral dose, co-administered with a fatty meal.</p><h4>References</h4><ol><li><a href='https://dx.doi.org/10.1093/jac/30.6.865'>10.1093/jac/30.6.865</a> Pharmacokinetic parameters from Horton J, et al. (1992), and other published sources. Co-administration with food increases systemic exposure and bioavailability.</li></ol></body></html>",
