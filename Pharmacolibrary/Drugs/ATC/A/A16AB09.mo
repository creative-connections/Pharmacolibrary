...
model A16AB09
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Idursulfase</td></tr><tr><td>ATC code:</td><td>A16AB09</td></tr><td>route:</td><td>intravenous</td></tr>
