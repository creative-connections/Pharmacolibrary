...
model A12CE02
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>SodiumSelenite</td></tr><tr><td>ATC code:</td><td>A12CE02</td></tr><td>route:</td><td>intravenous</td></tr>
