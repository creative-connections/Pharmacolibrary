...
model A03AB21
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Fenpiverinium</td></tr><tr><td>ATC code:</td><td>A03AB21</td></tr><td>route:</td><td>oral</td></tr>
