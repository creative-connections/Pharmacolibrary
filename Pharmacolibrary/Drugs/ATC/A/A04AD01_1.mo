...
model A04AD01_1
  extends Pharmacokinetic.Models.PK_2C(
    ...
    Ctox_trough    = 0.01,            
    Vdp             = 0.0101,
    k12             = 1.6916666666666667e-05,
    k21             = 1.6916666666666667e-05
    
  );
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Scopolamine_1</td></tr><tr><td>ATC code:</td><td>A04AD01_1</td></tr><td>route:</td><td>transdermal</td></tr>
