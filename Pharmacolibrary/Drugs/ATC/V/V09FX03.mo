...
model V09FX03
  ...
  annotation(Documentation(
    info ="<html><body><p>Sodium iodide (131I) is a radiopharmaceutical used primarily in the diagnosis and treatment of thyroid disorders, such as hyperthyroidism and differentiated thyroid cancer. The radioactive isotope iodine-131 emits both beta and gamma radiation, enabling its use in both diagnostic imaging and targeted ablation of thyroid tissue. It remains an approved and widely utilized agent in nuclear medicine.</p><h4>Pharmacokinetics</h4><p>Pharmacokinetic parameters reported in euthyroid adult patients following oral administration during diagnostic and therapeutic use.</p><h4>References</h4><ol><li><a href='https://dx.doi.org/10.2967/jnumed.109.065961'>10.2967/jnumed.109.065961</a> PK values extracted from published literature in adult patients; parameters can vary depending on thyroid function, age, and dosing.</li></ol></body></html>",
