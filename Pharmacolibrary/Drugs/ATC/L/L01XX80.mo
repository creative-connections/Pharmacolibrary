...
model L01XX80
  extends Pharmacokinetic.Models.PK_2C(
    weight         = 70,
    F              = 1,
    Cl             = 3.1833333333333335e-06,
    adminDuration  = 600,
    adminMass      = 9.4 / 1000000,   // mg → kg
    adminCount     = 1,
    Vd             = 0.0125,
    Cmin           = 0.001,
    Cmax           = 0.01,
