...
model N04BC05
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Pramipexole</td></tr><tr><td>ATC code:</td><td>N04BC05</td></tr><td>route:</td><td>oral</td></tr>
