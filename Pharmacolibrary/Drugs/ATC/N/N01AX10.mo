...
extends Pharmacolibrary.Pharmacokinetic.Models.PK_3C_ES(
  ...
  Ctox_peak = 0.02, 
  Ctox_trough = 0.01, 
  effectSite(ke = 2.82e-6));
  annotation (Documentation(info = "<html><body><table><tr><td>name:</td><td>Propofol</td></tr><tr><td>ATC code:</td><td>N01AX10</td></tr><td>route:</td><td>intravenous</td></tr>
