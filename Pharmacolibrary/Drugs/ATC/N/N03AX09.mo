...
model N03AX09
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Lamotrigine</td></tr><tr><td>ATC code:</td><td>N03AX09</td></tr><td>route:</td><td>oral</td></tr>
