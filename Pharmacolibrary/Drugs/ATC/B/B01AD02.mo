...
model B01AD02
  ...
  annotation (Documentation(
    info       = "<html><body><table><tr><td>name:</td><td>Alteplase</td></tr><tr><td>ATC code:</td><td>B01AD02</td></tr><td>route:</td><td>intravenous</td></tr>
