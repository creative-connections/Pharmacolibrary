...
model PK_1C_Gentamicin
  extends Pharmacolibrary.Examples.PKOneCompartmentModel(singleDose(firstAdminTime = 3600, adminMass = 4e-4, adminDuration = 60, F = 1), central(V = 0.0175, fu), elim(CL = 1.6666666666666667e-6));
