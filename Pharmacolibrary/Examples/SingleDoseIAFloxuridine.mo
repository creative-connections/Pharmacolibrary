...
model SingleDoseIAFloxuridine
  ...
  Pharmacolibrary.Pharmacokinetic.FixedFlow fixedFlow1(Q = 1.7833333333333334e-5) annotation(
  ...
  Pharmacolibrary.Pharmacokinetic.ClearanceDrivenElimination elimination(CL = 1.6666666666666667e-8) annotation(
