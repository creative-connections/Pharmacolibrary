...
equation
  ...
  annotation(
    experiment(StartTime = 0, StopTime = 43200, Tolerance = 1e-06, Interval = 86.4), Diagram(
        graphics={
        Rectangle(
          origin={90,-30},
          lineColor={38,162,105},
          lineThickness=0.75,
          extent={{-20,30},{20,-30}}),
        Text(
          origin={89,-64},
          textColor={38,162,105},
          extent={{-17,4},{17,-4}},
        ...
        Rectangle(
          origin={-64,-69},
          lineColor={53,132,228},
          lineThickness=0.75,
          extent={{-34,17},{34,-17}}),
        Text(
          origin={-80,-55},
          textColor={53,132,228},
          extent={{-18,3},{18,-3}},
          textString="Elimination")}));
