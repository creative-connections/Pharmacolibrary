...
equation
  ...
  annotation(
    ...
    Documentation(info = "<html><head></head><body><p>Parameters of PD influence on HR and compliance of left ventricle are for ilustrative estimates. Other parameters are from referred articles. Model of hemodynamics of cardiovascular system [1] and PKPD model of digoxin effect [2].&nbsp;</p><p>[1] W. van Meurs, Modeling and Simulation in Biomedical Engineering: Applications in Cardiorespiratory Physiology, McGraw-Hill Professional, 2011.</p><div>[2]&nbsp;Hornestam, B., Jerling, M., Karlsson, M.O. et al. Intravenously administered digoxin in patients with acute atrial fibrillation: a population pharmacokinetic/pharmacodynamic analysis based on the Digitalis in Acute Atrial Fibrillation trial. Eur J Clin Pharmacol 58, 747–755 (2003). https://doi.org/10.1007/s00228-002-0553-3</div>
