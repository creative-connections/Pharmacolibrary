...
equation
  ...
  //  port_a.p = 1;
  annotation(
    Icon(graphics = {Polygon(rotation = 180, lineColor = {204, 0, 0}, lineThickness = 0.5, points = {{-80, 0}, {80, 40}, {80, -40}, {-80, 0}, {-80, 0}}), Text(origin = {0, -59}, extent = {{260, -11}, {-260, 11}}, textString = "Q=%Q")}, coordinateSystem(initialScale = 0.1)),
