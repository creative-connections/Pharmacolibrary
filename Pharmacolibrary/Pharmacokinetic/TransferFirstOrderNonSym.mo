...
equation
  ...
  annotation(
    Icon(graphics = {Text(origin = {18, -15}, extent = {{-88, 33}, {56, -5}}, textString = "1"), Text(origin = {1, 53}, extent = {{-121, 15}, {121, -15}}, textString = "Cla=%CLa"), Text(origin = {3, -53}, extent = {{-121, 15}, {121, -15}}, textString = "Clb=%CLb")}),
